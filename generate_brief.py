...
<head>
  ...
  <style>
    *, *::before, *::after {{ margin:0; padding:0; box-sizing:border-box; }}
    ...
    .yuzu-fab-cam {{ display:flex; align-items:center; gap:12px; background:linear-gradient(145deg,#253f68 0%,#1b2d4f 55%,#14233d 100%); color:rgba(255,255,255,.93); text-decoration:none; padding:10px 18px 10px 10px; border-radius:50px; font-family:'DM Sans','Noto Sans TC',sans-serif; box-shadow:0 1px 0 rgba(255,255,255,.14) inset,0 6px 22px rgba(8,16,42,.52),0 2px 6px rgba(0,0,0,.2); border:1px solid rgba(255,255,255,.14); transition:transform .25s cubic-bezier(.34,1.56,.64,1),box-shadow .25s; }}
    .yuzu-fab-cam:hover {{ transform:translateY(-4px) scale(1.04); box-shadow:0 1px 0 rgba(255,255,255,.2) inset,0 14px 38px rgba(8,16,42,.68),0 2px 8px rgba(0,0,0,.26); color:#fff; border-color:rgba(255,255,255,.24); }}
